...
package klock.simpleComponents.components
{
	...
	public class NumStep extends BaseElement
	{
		...
		public function NumStep( initObject:Object, value:uint, parent:DisplayObjectContainer = null, defaultListener:Function = null)
		{
			_value = value
		...
		{
			//addChild( _tf = new InputText( {x:_height-BaseLayout.LEFT, y:0, _width: _width-_height*2+BaseLayout.LEFT*2 }, _value.toString(), this, onValueTextChange ) )
