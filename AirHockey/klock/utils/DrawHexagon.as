package klock.utils
{
	...
	{
		public  static function get HEXAGON()	:Object { return { a: (GRID.SIZE*.5)*.5, b:SIN60D*(GRID.SIZE*.5), c:(GRID.SIZE*.5) }} 
		...
		public static function DRAW( graphics:Graphics, color:uint = 0xffffff, alpha:Number = 1, clear:Boolean = false, onlyOutline:Boolean = false ):void
		{
			...
			var o:Point = new Point(0,0)// -Gameboard.SIZE*.5 , -SIN60D*(Gameboard.SIZE) )
