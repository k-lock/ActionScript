	...
	//		_panel.content.addChild(_itemHolder);
		...
		protected function makeListItems():void
		{
			...
			for(var i:int = 0; i < numItems; i++)
			{
				...
				item.setSize( _width - BaseLayout.LEFT - uint((_scrollbar.autoHide )? 0 : 10 ) , _listItemHeight);
...
//			fillItems();
	...
	*/		
			...
			// scrollbar
			_scrollbar.setSize( _width, _height)
	...
	//		_scrollbar.pageSize = pageSize;
			...
			BaseLayout.DRAW_RECT( _mask.graphics, _width-BaseLayout.LEFT -  uint((_scrollbar.autoHide )? 0 : 10 ), _height-BaseLayout.LEFT*2)	
