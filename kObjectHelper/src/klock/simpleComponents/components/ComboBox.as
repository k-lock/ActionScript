...
package klock.simpleComponents.components
{
	...
	public class ComboBox extends BaseElement
	{
		...
		protected override function AddChilds():void
		{
			...
			_labelButton    = new Button({name:"LB",_width:__width-_height, pushMode:true },_label , this, onDropDown);
			_dropDownButton = new Button({name:"DB",x:__width-_height, _width:_height},"+", this, onDropDown);
...
///////////////////////////////////
		...
		{
			super.Draw();
			_labelButton.setSize(__width - _height + 1, _height);
			_labelButton.Draw();
			
			_dropDownButton.setSize(_height, _height);
			_dropDownButton.Draw();
			_dropDownButton.x = __width - height;
			
			_list.setSize( __width, _numVisibleItems * _list.listItemHeight);
		}
