...
package klock.simpleComponents.components
{
	...
	public class NumStep extends BaseElement
	{
		...
		{
			addChild( _tf = new InputText( {x:_height, y:0, _width: __width-_height*2 }, _value.toString(), this, onValueTextChange ) )
			addChild( _minus = new Button( {x:0, y:0, _width:_height}, "-", this ) )
			addChild( _plus  = new Button( {x:__width-_height, y:0,_width:_height}, "+", this ) )
