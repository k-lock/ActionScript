...
///////////////////////////////////
		...
		override public function Draw():void
		{
			...
			BaseLayout.DRAW_FILLIN( _background.graphics, __width, _height, 2, _color )
			...
			var g:Graphics = _mask.graphics
				...
				g.drawRect(0, 0, __width, _height);
				g.endFill();
		}
		...
		protected function drawGrid():void
		{
			...
			var w:Number = __width - BaseLayout.LEFT*2
			var g:Graphics = _background.graphics
				g.lineStyle(0, ( _gridColor != -1 ) ? _gridColor : BaseLayout.PANELGRID );
			for(var i:int = _gridSize; i < __width; i += _gridSize){
				g.moveTo(i, 0);
